...
#do we need to do anything for the above? 
...
## get subjects that having changes > 0.18 compared to baseline before Time15
kk = kk[kk$Time<15,]
kk$change = (kk$SBP - kk$baselineSBP)/kk$baselineSBP

kk = kk[kk$change>0.15,]
...
aucJM(coxfit2, newdata= ND.id, idVar = "ID_d", respVar = "cvd", timeVar = "Time", evTimeVar = "ttocvd", Thoriz= 25, Tstart=15)
#0.8892
